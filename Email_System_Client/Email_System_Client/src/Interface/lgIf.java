...
public class lgIf extends JFrame implements ActionListener{
	...
	public lgIf() {
		...
		lbImage.setIcon(new ImageIcon(lgIf.class.getResource("/Image_Icon/lll.png")));
...
//		ObjectOutputStream objectOutputStream = new ObjectOutputStream(outputStream);
        ...
        output.println(tfUsername.getText());
        ...
        else
        {
            ...
            EmailInterface a = new EmailInterface(response, id);
            a.setVisible(true);
            this.dispose();
        }
        socket.close();
...
//			this.dispose();
//			EmailInterface a = new EmailInterface();
//			a.setVisible(true);
//		}
	}
